...
export const dummyDestination: DestinationType[] = [
  ...
  { 
    ...
    img: 'assets/goa-selomangleng.webp', 
  ...
  { 
    ...
    img: 'assets/air-terjun-dolo.webp', 
  ...
  { 
    ...
    img: 'assets/kampung-inggris.webp', 
  ...
  { 
    ...
    img: 'assets/candi-surawana.webp', 
...
export const dummyEvent: EventType[] = [
  {
    ...
    img: 'assets/karya-kreatif-mataraman.webp' // Tema pameran/festival malam
  },
  {
    id: 'evt-2',
    ...
    img: 'assets/jamda-rx-king.webp' // Tema motor/komunitas
  },
  {
    id: 'evt-3',
    ...
    time: '11 - 12 Juli 2026',
    img: 'assets/selomangleng-performance-art.webp' // Tema seni tari/budaya
  }
];
